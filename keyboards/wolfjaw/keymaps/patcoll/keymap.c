...
[_QWERTY] = LAYOUT_wrapper(
  ...
  KC_LCTL, KC_LGUI, KC_LALT, SFT_SPC, RSE_ENT, KC_RALT, KC_RGUI, KC_RCTL
),
...
[_NAV] = LAYOUT_wrapper(
  ...
  _______, __________________NAV_L3___________________, __________________NAV_R3___________________,
